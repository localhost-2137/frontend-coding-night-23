...
export default function AvatarEditorModal({
  ...
  setIsUserEditingAvatar: (value: boolean) => void;
  setAvatarBlob: (value: Blob | undefined) => void;
  avatarEditingOptions?: avatarOptions;
  setAvatarEditingOptions: (
    value: { scale: number; rotate: number } | undefined
  ) => void;
  avatarBlob?: Blob;
}) {
  ...
  function setScale(e: React.ChangeEvent<HTMLInputElement>) {
    setAvatarEditingOptions({
